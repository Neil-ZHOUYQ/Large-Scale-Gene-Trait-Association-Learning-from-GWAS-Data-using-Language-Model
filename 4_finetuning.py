...
root_path = "/mnt/home/kenneth/out/nlp/biomedbert"
...
ctrl_dataset_path = os.path.join(root_path, "datasets", "ctrl", "parallel_run", "ctrl_train_dataset.GWAS_ASD.20250430.txt")
...
model_path =  os.path.join(root_path, "DAP/241111_090405_E3_B32_LR2e-05_WD0.01")
